...
This is to minimize maintainer burden, since when plugin options may have their
type changed/extended or even removed/renamed entirely, we have to update it on
our side as well.
